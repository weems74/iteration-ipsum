...
incident_jargon = [ "redeploying", "API", "integration", "cloudwatch", "expired certificate", "baseline", "availability zones", "security group", "failure", "monitoring", "alert", "AWS","Azure","terraform","cloud formation script","postgres","load balancer", "endpoint", "threads", "application", "fatal", "roll back", "maintenance page", "devops", "404 error", "403 error", "500 error", "docker","container", "microservice", "object durability", "Lambda","versioning","firewall","credentials","isolating","root cause","iterating","cluster","mount","logs","feature toggle","database"]
